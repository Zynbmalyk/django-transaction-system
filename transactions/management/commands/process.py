       ...
       for transaction_data in transactions_data:
        ...
        try:
            source_account = BankAccount.objects.get(
                account_number=transaction_data['source_account']
            )

            target_account = BankAccount.objects.get(
                account_number=transaction_data['target_account']
            )
            ...
            print(
                f"Account not found for transaction: {transaction_data}"
            )

        self.stdout.write(
        f"Processing completed. Successful: {success}, Failed: {failed}"
    )
